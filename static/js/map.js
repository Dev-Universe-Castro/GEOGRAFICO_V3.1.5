...
// Array para armazenar múltiplas camadas de território
let revendaLayers = [];
...
async function loadReceitasLayerForLayer(layer) {
        ...
        async function loadMunicipalityBoundariesForRevendasLayer(layer, layerData, minMax) {
            try {
                ...
                // Store municipality details for analytics
                layer.municipalityDetails = filteredFeatures.map(feature => {
                    const municipalityCode = feature.properties.GEOCODIGO || feature.properties.CD_MUN || feature.properties.cd_geocmu || feature.properties.geocodigo;
                    const municipalityName = feature.properties.NOME || feature.properties.NM_MUN || feature.properties.nm_mun || feature.properties.nome || `Município ${municipalityCode}`;
                    const stateCode = feature.properties.UF || feature.properties.SIGLA_UF || feature.properties.uf || 'XX';
